...
int main()
{
	...
	int block_size=32;
	int nrows=100*block_size;
	int ncols=200*block_size;
	...
	/********** ON GPU *****************/
	/* Allocate Device Memory (d_MatA, d_MatB, d_MatC) */
	// TODO //
	/***********************************/
	...
	Start=cpuTimer();
	// copy host memory to device (MatA -> d_MatA, MatB->d_MatB)
	// TODO //
	/***********************************************************/
